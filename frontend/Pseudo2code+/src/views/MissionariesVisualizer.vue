...
.mc-bank-right { background: var(--bg-hover); border: 1px solid var(--accent-border); }
.mc-bank-label { font-size: 0.85rem; font-weight: 700; color: var(--text-primary); margin: 0 0 16px; }
...
.mc-bank-count { display: flex; gap: 14px; font-size: 0.78rem; font-weight: 700; color: var(--text-muted); margin-top: auto; padding-top: 12px; }
...
.mc-move-badge { position: absolute; bottom: 14px; background: rgba(99,102,241,0.2); border: 1px solid var(--accent-border); padding: 3px 10px; border-radius: 8px; font-size: 0.7rem; font-weight: 600; color: var(--accent-lighter); white-space: nowrap; }

/* Status indicator */
.mc-status-indicator { text-align: center; font-size: 0.82rem; font-weight: 600; padding: 8px 14px; border-radius: 8px; margin-top: 12px; background: rgba(100,116,139,0.1); color: var(--text-tertiary); }
.mc-si-exploring { background: rgba(34,197,94,0.08); color: var(--success-text); }
.mc-si-success { background: rgba(139,92,246,0.1); color: var(--accent-light); }
.mc-si-failed { background: rgba(239,68,68,0.08); color: var(--error-text); }
...
/* Boat Info */
.mc-boat-info { background: var(--bg-elevated); padding: 8px 10px; border-radius: 6px; }
.mc-info-row { display: flex; justify-content: space-between; font-size: 0.78rem; margin-bottom: 4px; }
.mc-info-label { color: var(--text-dim); }
.mc-info-val { color: var(--accent-lighter); font-weight: 600; }
.mc-val-left { color: var(--success-text); }
.mc-val-right { color: var(--accent-lighter); }

/* Path Log */
.mc-path-log { background: var(--bg-elevated); padding: 8px 10px; border-radius: 6px; max-height: 120px; overflow-y: auto; }
.mc-path-log::-webkit-scrollbar { width: 3px; }
.mc-path-log::-webkit-scrollbar-thumb { background: var(--border-medium); border-radius: 2px; }
.mc-path-entry { display: flex; align-items: center; gap: 6px; font-size: 0.72rem; color: var(--text-muted); padding: 2px 0; }
.mc-path-current { color: var(--accent-lighter); font-weight: 600; }
.mc-path-num { font-weight: 700; color: var(--text-dim); font-family: 'Fira Code', monospace; min-width: 24px; }
.mc-path-text { flex: 1; }
.mc-no-path { font-size: 0.72rem; color: var(--text-faint); font-style: italic; }
