...
.mm-board { display: grid; grid-template-rows: repeat(3, 1fr); gap: 4px; background: rgba(100,116,139,0.3); padding: 4px; border-radius: 12px; }

.mm-row { display: grid; grid-template-columns: repeat(3, 1fr); gap: 4px; }

.mm-cell { width: 90px; height: 90px; background: rgba(15,23,42,0.8); border-radius: 8px; display: flex; align-items: center; justify-content: center; transition: all 0.3s ease; position: relative; }
...
.mm-badge-max { background: rgba(34,197,94,0.12); border: 1px solid rgba(34,197,94,0.3); color: #86efac; }
.mm-badge-min { background: rgba(239,68,68,0.1); border: 1px solid rgba(239,68,68,0.3); color: #fca5a5; }
.mm-badge-done { background: rgba(139,92,246,0.12); border: 1px solid rgba(139,92,246,0.3); color: #c4b5fd; }

.mm-depth-badge { padding: 4px 12px; border-radius: 8px; font-size: 0.75rem; font-weight: 600; background: rgba(99,102,241,0.12); border: 1px solid rgba(99,102,241,0.3); color: #a5b4fc; }
...
/* Mini Board */
.mm-board-mini { background: rgba(15,23,42,0.5); padding: 8px; border-radius: 6px; display: flex; flex-direction: column; align-items: center; gap: 2px; }
.mm-mini-row { display: flex; gap: 2px; }
.mm-mini-cell { width: 28px; height: 28px; display: flex; align-items: center; justify-content: center; font-size: 0.7rem; font-weight: 700; font-family: 'Fira Code', monospace; color: #94a3b8; background: rgba(100,116,139,0.15); border-radius: 4px; }

/* Eval Log */
.mm-eval-log { background: rgba(15,23,42,0.5); padding: 8px 10px; border-radius: 6px; max-height: 140px; overflow-y: auto; }
.mm-eval-log::-webkit-scrollbar { width: 3px; }
.mm-eval-log::-webkit-scrollbar-thumb { background: rgba(100,116,139,0.3); border-radius: 2px; }
.mm-eval-entry { display: flex; align-items: center; gap: 6px; font-size: 0.72rem; color: #94a3b8; padding: 2px 0; }
.mm-eval-current { color: #e0e7ff; font-weight: 600; }
.mm-eval-num { font-weight: 700; color: #64748b; font-family: 'Fira Code', monospace; min-width: 24px; }
...
.mm-eval-text { flex: 1; }
.mm-no-eval { font-size: 0.72rem; color: #475569; font-style: italic; }
