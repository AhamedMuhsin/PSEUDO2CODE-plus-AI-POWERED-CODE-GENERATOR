...
/* Status badge */
.hc-status-badge { padding: 8px 18px; border-radius: 10px; font-size: 0.82rem; font-weight: 600; text-align: center; background: rgba(100,116,139,0.1); border: 1px solid var(--border-default); color: var(--text-tertiary); }
.hc-sb-explore { background: rgba(245,158,11,0.08); border-color: rgba(245,158,11,0.25); color: #fbbf24; }
.hc-sb-climb { background: rgba(34,197,94,0.08); border-color: rgba(34,197,94,0.25); color: var(--success-text); }
.hc-sb-stuck { background: rgba(239,68,68,0.08); border-color: rgba(239,68,68,0.25); color: var(--error-text); }
.hc-sb-done { background: rgba(139,92,246,0.1); border-color: rgba(139,92,246,0.3); color: var(--accent-light); }
...
.hc-state-box { background: var(--bg-elevated); border-radius: 8px; padding: 8px 10px; display: flex; flex-direction: column; align-items: center; }
.hc-st-label { font-size: 0.68rem; color: var(--text-dim); font-weight: 600; letter-spacing: 0.02em; }
.hc-st-value { font-size: 1.3rem; font-weight: 800; color: var(--text-primary); font-family: 'Fira Code', monospace; }
.hc-gap-zero { color: #22c55e !important; }

/* Neighbors */
.hc-neighbors-list { background: var(--bg-elevated); border-radius: 6px; padding: 6px 8px; }
.hc-neighbor-item { display: flex; justify-content: space-between; align-items: center; font-size: 0.78rem; color: var(--text-muted); padding: 3px 4px; border-radius: 4px; }
.hc-neighbor-item.hc-nb-best { background: rgba(34,197,94,0.08); color: var(--success-text); }
...
.hc-no-nb { font-size: 0.72rem; color: var(--text-faint); font-style: italic; }

/* Best Neighbor */
.hc-best-display { background: rgba(34,197,94,0.06); border: 1px solid rgba(34,197,94,0.2); border-radius: 6px; padding: 8px 10px; display: flex; justify-content: space-around; font-size: 0.82rem; font-weight: 600; color: var(--success-text); font-family: 'Fira Code', monospace; }

/* State History */
.hc-history-log { background: var(--bg-elevated); padding: 6px 8px; border-radius: 6px; max-height: 120px; overflow-y: auto; }
.hc-history-log::-webkit-scrollbar { width: 3px; }
.hc-history-log::-webkit-scrollbar-thumb { background: var(--border-medium); border-radius: 2px; }
.hc-history-item { display: flex; gap: 10px; font-size: 0.72rem; color: var(--text-muted); padding: 2px 0; }
.hc-hist-current { color: var(--accent-lighter); font-weight: 600; }
.hc-hist-num { color: var(--text-dim); font-weight: 700; font-family: 'Fira Code', monospace; min-width: 24px; }
.hc-hist-val { color: var(--accent-light); font-family: 'Fira Code', monospace; }
