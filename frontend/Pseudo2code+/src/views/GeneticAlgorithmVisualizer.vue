...
.bs-chart-wrapper{background:var(--bg-card);border: 1px solid var(--border-default);border-radius:12px;padding:18px 20px 12px;display:flex;flex-direction:column}
.bs-chart-footer{display:flex;justify-content:space-between;font-size:.74rem;color:var(--text-dim);padding:8px 0 6px}
.bs-scrubber{width:100%;accent-color: var(--accent-light);cursor:pointer;margin-top:8px}
.bs-status-bar{background:var(--bg-card);border: 1px solid var(--border-default);border-radius:10px;padding:14px 22px;text-align:center;font-size:.9rem;color:var(--text-secondary);font-weight:500}
...
.ga-gen-label{font-size:.82rem;color:var(--text-muted);font-weight:600;letter-spacing:.04em}
.ga-gen-num{font-size:2rem;font-weight:900;color:var(--accent-light);font-family:'Fira Code',monospace}
/* Population grid */
.ga-pop-grid{width:100%;max-width:520px;display:flex;flex-direction:column;gap:8px}
.ga-chromo-row{display:flex;align-items:center;gap:8px;padding:8px 12px;background:var(--bg-elevated);border-radius:8px;border: 1px solid var(--border-default);transition:all .2s}
.ga-chromo-best{border-color:rgba(34,197,94,.35);background:rgba(34,197,94,.04)}
.ga-chromo-idx{font-size:.72rem;color:var(--text-dim);font-weight:700;min-width:22px}
...
.ga-bit-1{background:rgba(34,197,94,.15);color: var(--success-text);border:1px solid rgba(34,197,94,.3)}
.ga-bit-0{background:rgba(239,68,68,.08);color: var(--error-text);border:1px solid rgba(239,68,68,.15)}
.ga-bit-target{background:rgba(139,92,246,.12);color: var(--accent-light);border:1px solid rgba(139,92,246,.25)}
.ga-fit-bar-track{flex:1;height:8px;background:rgba(100,116,139,.15);border-radius:4px;overflow:hidden;min-width:80px}
.ga-fit-bar-fill{height:100%;background: var(--accent);border-radius:4px;transition:width .3s}
.ga-fit-100{background: var(--accent)!important}
.ga-fit-val{font-size:.82rem;font-weight:700;color:var(--accent-lighter);font-family:'Fira Code',monospace;min-width:38px;text-align:right}
/* Target row */
.ga-target-row{display:flex;align-items:center;gap:12px}
.ga-target-lbl{font-size:.78rem;color:var(--text-muted);font-weight:600}
...
.ga-fs-label{font-size:.68rem;color:var(--text-dim);font-weight:600;letter-spacing:.04em}
.ga-fs-val{font-size:1.5rem;font-weight:900;color:var(--text-primary);font-family:'Fira Code',monospace}
.ga-fs-perfect{color:#22c55e!important;text-shadow:0 0 12px rgba(34,197,94,.4)}
/* Status */
.ga-status-badge{padding:10px 20px;border-radius:10px;font-size:.82rem;font-weight:600;text-align:center;background:rgba(100,116,139,.1);border: 1px solid var(--border-default);color:var(--text-tertiary);width:100%;max-width:480px}
...
.ga-sb-selection{background:rgba(167,139,250,.08);border-color:rgba(167,139,250,.25);color: var(--accent-light)}
.ga-sb-crossover{background:rgba(6,182,212,.08);border-color:rgba(6,182,212,.25);color:#67e8f9}
.ga-sb-mutation{background:rgba(239,68,68,.08);border-color:rgba(239,68,68,.25);color: var(--error-text)}
.ga-sb-new_generation{background:rgba(34,197,94,.08);border-color:rgba(34,197,94,.25);color: var(--success-text)}
.ga-sb-success{background:rgba(139,92,246,.1);border-color:rgba(139,92,246,.3);color: var(--accent-light)}
/* Inspector */
...
.ga-gi-item{background:var(--bg-elevated);border-radius:8px;padding:8px 10px;display:flex;flex-direction:column;align-items:center}
.ga-gi-lbl{font-size:.68rem;color:var(--text-dim);font-weight:600}.ga-gi-val{font-size:1.2rem;font-weight:800;color:var(--text-primary);font-family:'Fira Code',monospace}
/* Fitness chart */
.ga-fitness-chart{display:flex;align-items:flex-end;gap:3px;height:60px;background:var(--bg-elevated);border-radius:6px;padding:6px 8px}
.ga-fc-bar{flex:1;background: var(--accent);border-radius:2px 2px 0 0;min-width:4px;transition:height .3s}
.ga-fc-100{background: var(--accent)!important}
.ga-fc-labels{display:flex;justify-content:space-between;font-size:.65rem;color:var(--text-faint);margin-top:2px}
/* Pop detail */
.ga-pop-detail{background:var(--bg-elevated);padding:6px 8px;border-radius:6px;max-height:110px;overflow-y:auto}
...
.ga-pd-item{display:flex;align-items:center;gap:6px;font-size:.72rem;color:var(--text-muted);padding:2px 0}
.ga-pd-best{color: var(--success-text);font-weight:600}
.ga-pd-idx{font-weight:700;color:var(--text-dim);font-family:'Fira Code',monospace;min-width:22px}
...
/* Evo log */
.ga-evo-log{background:var(--bg-elevated);padding:6px 8px;border-radius:6px;max-height:120px;overflow-y:auto}
.ga-evo-log::-webkit-scrollbar{width:3px}.ga-evo-log::-webkit-scrollbar-thumb{background:rgba(100,116,139,.3);border-radius:2px}
.ga-evo-entry{display:flex;align-items:center;gap:6px;font-size:.72rem;color:var(--text-muted);padding:2px 0}
.ga-evo-cur{color:var(--accent-lighter);font-weight:600}
.ga-evo-num{font-weight:700;color:var(--text-dim);font-family:'Fira Code',monospace;min-width:24px}
...
.ga-evo-text{flex:1}.ga-no-evo{font-size:.72rem;color:var(--text-faint);font-style:italic}
/* Sections */
...
.bs-section-body{padding:0 24px 24px;color:var(--text-tertiary);font-size:.92rem;line-height:1.8}
